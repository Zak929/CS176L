...
public class PersonTester
{
   public static void main(String[] args)
   {
       ...
       */
	   Person p1 = new Person(1965, "John");
	   Person p2 = new Person(1970, "Mary Ann");
	   Student s1 = new Student(1982, "Ann", "Computer Science");
	   Student s2 = new Student(1986, "Thomas", "Biology");
	   Instructor i1 = new Instructor(1954, "Joseph", 65000);
